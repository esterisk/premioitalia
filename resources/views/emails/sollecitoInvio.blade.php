...
<p>Tra poco (il voto è aperto fino alla mezzanotte del {{ _date(($annata->fase() == 'fase1' ? $annata->fase_1_a : $annata->fase_2_a), 'j F') }}) scadrà il termine per votare; ricorda che se non avrai inviato il voto, esso non potrà essere preso in considerazione.</p>
