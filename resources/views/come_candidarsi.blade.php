...
@section('content')
	...
	<div class="row row-regolamento">
		<div class="col-sm-12">
			...
			<p>Dall'edizione 2020 è anche possibile inserire su una bacheca su questo sito le proprie proposte. Le candidature spontanee vengono valutate dalla redazione e, se considerate valide rispetto al regolamento del premio e della specifica categoria, aggiunte alla lista delle candidature spontanee che nella prima fase del voto vero e proprio possono, non obbligatoriamente, essere scelte dai votanti.</p>
			<p>Le candidature spontanee vengono aperte qualche settimana prima dell'inizio delle votazioni.</p>
