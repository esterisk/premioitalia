...
<table cellpadding="3" cellspacing="0" class="table tabella-fasi">
    <tr {!! $fase == 'fase0' ? 'class="active"' : '' !!}>
        ...
        <td>Votazione aperta da {{ _date($annata->candidature_da, 'j F') }} a {{ _date($annata->candidature_a, 'j F Y') }}</td>
    </tr>
    <tr {!! $fase == 'fase1' ? 'class="active"' : '' !!}>
        ...
        <td>Votazione aperta da {{ _date($annata->fase_1_da, 'j F') }} a {{ _date($annata->fase_1_a, 'j F Y') }}</td>
    </tr>
    <tr {!! $fase == 'spoglio1' ? 'class="active"' : '' !!}>
        ...
        <td>Spoglio da {{ _date(_dateAdd($annata->fase_1_a, 1), 'j F') }} a {{ _date($annata->fase_2_da, 'j F Y') }}</td>
    </tr>
    <tr {!! $fase == 'fase2' ? 'class="active"' : '' !!}>
        ...
        <td>Votazione aperta da {{ _date($annata->fase_2_da, 'j F') }} a {{ _date($annata->fase_2_a, 'j F Y') }}</td>
    </tr>
    <tr {!! $fase == 'spoglio2' ? 'class="active"' : '' !!}>
        ...
        <td>Spoglio da {{ _date(_dateAdd($annata->fase_2_a, 1), 'j F') }} (votazioni chiuse)</td>
    </tr>
    <tr>
